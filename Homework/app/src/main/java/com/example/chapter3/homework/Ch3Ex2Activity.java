...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator translationX=ObjectAnimator.ofFloat(target,"alpha",1,0.5f);
        translationX.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        ...
        animatorSet.playTogether(animator1,scaleXAnimator,scaleYAnimator,translationX);
        animatorSet.start();
    }
}
